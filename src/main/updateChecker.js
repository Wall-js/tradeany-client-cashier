...
const release = 'https://api.github.com/repos/Wall-js/tradeany-client-cashier/releases/latest'
const downloadUrl = 'https://github.com/Wall-js/tradeany-client-cashier/releases/latest'
